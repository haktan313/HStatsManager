...
template<> HSTATSMANAGER_API UScriptStruct* StaticStruct<FS_DamageInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HStatsManager_HostProject_Plugins_HStatsManager_Source_HStatsManager_Public_HEnumsStructure_StatManager_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HStatsManager_HostProject_Plugins_HStatsManager_Source_HStatsManager_Public_HEnumsStructure_StatManager_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HStatsManager_HostProject_Plugins_HStatsManager_Source_HStatsManager_Public_HEnumsStructure_StatManager_h_2081590637(TEXT("/Script/HStatsManager"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HStatsManager_HostProject_Plugins_HStatsManager_Source_HStatsManager_Public_HEnumsStructure_StatManager_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Haktan_Desktop_pluginNewVersions_HStatsManager_HostProject_Plugins_HStatsManager_Source_HStatsManager_Public_HEnumsStructure_StatManager_h_Statics::ScriptStructInfo),
		nullptr, 0);
